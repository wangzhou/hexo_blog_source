...
tags:
  ...
  - KVM
  - 调度
description: 本文分析KVM虚拟化场景下vCPU上下线的基本逻辑，重点分析vCPU上下线的时间点。
abbrlink: 16100
date: 2026-04-19 23:46:16
categories:
---
...
KVM里让出CPU的点都有: 1. WFI/WFE的模拟逻辑，具体逻辑可以参考[这里](https://wangzhou.github.io/KVM中WFI-WFE的基本逻辑/)。
